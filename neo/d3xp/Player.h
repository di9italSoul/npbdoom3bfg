...
public:
	...
	renderLight_t			laserDotLight;
	qhandle_t				laserDotLightHandle;

	idVec3  laserDotSmoothedFwd;
	bool    laserDotAimSmoothingInit;
	int     laserDotLastUpdateTime;
	...
	float					weaponZoomBlend;	// smooth blend for zoomed weapon position
...
public:
	...
	void					WeaponFastRisingCallback();   // <-- add this line
